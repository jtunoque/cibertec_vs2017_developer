...
namespace Chinook.UI.WebForm.MantenimientoServices {
    ...
    public interface IMantenimientosServices {
        ...
        Chinook.UI.WebForm.MantenimientoServices.Artist[] GetArtitsByname(string artistName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMantenimientosServices/GetArtitsByname", ReplyAction="http://tempuri.org/IMantenimientosServices/GetArtitsBynameResponse")]
        System.Threading.Tasks.Task<Chinook.UI.WebForm.MantenimientoServices.Artist[]> GetArtitsBynameAsync(string artistName);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMantenimientosServices/GetArtitsById", ReplyAction="http://tempuri.org/IMantenimientosServices/GetArtitsByIdResponse")]
        Chinook.UI.WebForm.MantenimientoServices.Artist GetArtitsById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMantenimientosServices/GetArtitsById", ReplyAction="http://tempuri.org/IMantenimientosServices/GetArtitsByIdResponse")]
        System.Threading.Tasks.Task<Chinook.UI.WebForm.MantenimientoServices.Artist> GetArtitsByIdAsync(int id);
    }
    ...
    public partial class MantenimientosServicesClient : System.ServiceModel.ClientBase<Chinook.UI.WebForm.MantenimientoServices.IMantenimientosServices>, Chinook.UI.WebForm.MantenimientoServices.IMantenimientosServices {
        ...
        public Chinook.UI.WebForm.MantenimientoServices.Artist[] GetArtitsByname(string artistName) {
            return base.Channel.GetArtitsByname(artistName);
        }
        
        public System.Threading.Tasks.Task<Chinook.UI.WebForm.MantenimientoServices.Artist[]> GetArtitsBynameAsync(string artistName) {
        ...
        public Chinook.UI.WebForm.MantenimientoServices.Artist GetArtitsById(int id) {
            return base.Channel.GetArtitsById(id);
        }
        
        public System.Threading.Tasks.Task<Chinook.UI.WebForm.MantenimientoServices.Artist> GetArtitsByIdAsync(int id) {
            return base.Channel.GetArtitsByIdAsync(id);
        }
    }
}
